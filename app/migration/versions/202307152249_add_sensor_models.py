...
Revision ID: c4c6cb86cf58
Revises: b51bab782a92
Create Date: 2023-07-15 22:49:00.951777
...
def upgrade():
    ...
    sa.Column('drive_type', sa.String(length=20), nullable=False, comment='drive type'),
    ...
    sa.ForeignKeyConstraint(['frame_id'], ['public.frames.id'], name=op.f('fk_drive_sensors_frame_id_frames')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_drive_sensors')),
    schema='public'
    )
    op.create_table('ip_port_sensors',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('state', sa.String(length=10), nullable=True, comment='ip port state. listen or establish'),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['frame_id'], ['public.frames.id'], name=op.f('fk_ip_port_sensors_frame_id_frames')),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['frame_id'], ['public.frames.id'], name=op.f('fk_process_sensors_frame_id_frames')),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['frame_id'], ['public.frames.id'], name=op.f('fk_screenshot_sensors_frame_id_frames')),
    ...
    op.create_foreign_key(op.f('fk_frames_user_session_id_user_sessions'), 'frames', 'user_sessions', ['user_session_id'], ['id'], source_schema='public', referent_schema='public')
    op.drop_constraint('fk_user_sessions_user_id_users', 'user_sessions', type_='foreignkey')
    op.create_foreign_key(op.f('fk_user_sessions_user_id_users'), 'user_sessions', 'users', ['user_id'], ['id'], source_schema='public', referent_schema='public')
...
def downgrade():
    ...
    op.create_foreign_key('fk_frames_user_session_id_user_sessions', 'frames', 'user_sessions', ['user_session_id'], ['id'])
